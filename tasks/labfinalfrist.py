...
if __name__ == '__main__':
    ...
    for iteration in range(num_iterations):
        ...
        OUTPUT_FOLDER = "output_images_block"
    ...
    print(blocking_percentuals['fixed-rate']['latency'])
    print(blocking_percentuals['flex-rate']['latency'])
    print(blocking_percentuals['shannon']['latency'])
